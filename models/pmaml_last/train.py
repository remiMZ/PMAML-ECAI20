...
from utils import get_dataset, get_loss
from global_utils import Averager, Mean_confidence_interval, get_outputs_c_h, count_acc
...
if __name__=='__main__':
    ...
    parser.add_argument('--model-name', type=str, default='pmaml_every', help='Name of the model.')
    ...
    parser.add_argument('--backbone', type=str, default='conv4', 
        choices=['conv1','conv2','conv4'], help='The type of model backbone.')
    parser.add_argument('--teacher_backbone', type=str, default='conv4', 
    ...
    parser.add_argument('--temperature', type=float, default=10.0,
        choices=[2.0, 5.0, 10.0, 20.0],
        help='The temperature for knowledge distillation (default: 10).')
    parser.add_argument('--trade-lambda', type=float, default=0.9,
        choices=[0.3, 0.5, 0.7, 0.9, 1.0],
        help='Trade-off for FSL cross-entropy loss and knowledge distillation loss (default: 0.9).')
    ...
    parser.add_argument('--teacher-resume', action='store_true', 
        help='Continue from baseline trained model with largest epoch.')
    parser.add_argument('--teacher-resume-folder', type=str, default=None,
        help='Path to the folder the resume is saved to.')
                    ...
                    for val_batch_i, val_batch in enumerate(pbar, 1):
                        ...
                        for _ , (support_input, support_target, query_input,
                            ...
                            with torch.no_grad():
                                ...
                                val_acc += count_acc(query_logit, query_target)
        ...
        for test_batch_i, test_batch in enumerate(pbar, 1): 
            ...
            for _ , (support_input, support_target, query_input,
                ...
                with torch.no_grad():
                    ...
                    test_acc += count_acc(query_logit, query_target)
